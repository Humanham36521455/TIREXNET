        ...
        actions = {
            ...
            if (showSearch) {
                IconButton(onClick = onSearchClose) {
                    Icon(painterResource(R.drawable.ic_close_24dp), contentDescription = stringResource(R.string.acc_close))
                }
            } else {
            ...
            IconButton(onClick = { onAction(MainAction.ShowMirrlyDialog) }) {
                Icon(painterResource(R.drawable.ic_mirrly_24dp), contentDescription = stringResource(R.string.menu_item_mirrly_tg_proxy))
            }
